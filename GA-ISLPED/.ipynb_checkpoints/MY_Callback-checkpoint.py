...
class RunningMetric(AnimationCallback):
    ...
    def __init__(self,
        ...
        self.term = DefaultMultiObjectiveTermination()
        #self.term = MultiObjectiveSpaceToleranceTerminationWithRenormalization(n_last=100000,all_to_current=True,sliding_window=False)
        self.hist = []
        self.hist = []
